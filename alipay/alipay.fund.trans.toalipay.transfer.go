...
func (c *Client) AlipayFundTransToalipayTransfer(ctx context.Context, request *types.FundTransToalipayTransfer) (*types.AlipayFundTransToalipayTransferResponse, error) {
